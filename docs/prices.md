...
|article_show| Пользовательское представление артикула|28113-2F800|
...
|status|Булево|Статус выполнения метода|
|message|Строка|Всегда возвращает текст «ОК»|
|data|Пустое значение|Метода не возвращает данных|



# Загрузить записи прайс-листа

Загрузка новых записей прайс-листа на сайт. При загрузке строки с незаполненным Артикулом и производителем будут пропущены. В поле data результата отображается количество пропущенных товаров.
